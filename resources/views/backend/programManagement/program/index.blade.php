...
<div class="card">
    ...
    <div class="d-lg-flex align-items-center mb-4 gap-3">
        <div class="position-relative">
            <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i> Liste des programmes</h6>
        </div>
        <div class="ms-auto"><a href="{{route("programmes.create")}}" title="Creer un nouveau programme" class="btn btn-outline-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Ajouter</a></div>
    </div> <hr>
                ...
                <tbody>
                    ...
                    @foreach ($datas as $d)
                        <tr>
                            <td>{{$d->code}}</td>
                            <td>{{$d->libelle}}</td>
                            <td> << {{$d->formatDateShort($d->dateDebut)}} -- {{$d->formatDateShort($d->dateFin)}} >></td>
                            ...
                            <td>{{$d->section->code}} - {{$d->section->libelle}}</td>
                             <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <a class="ms-1" href="{{ route('programmes.edit', $d->id) }}">
