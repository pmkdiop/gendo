                        ...
                        <div class="col-lg-12">
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" value="{{ $tache->code }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="libelle" value="{{ $tache->libelle }}"
                                        class="form-control @error('libelle') is-invalid @enderror" id="InputLibelle"
                                        placeholder="Saissisez le libelle du tâche">
                                    @error('libelle')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="composant_id"
                                        class="form-select @error('composant_id') is-invalid @enderror"
                                        id="single-select-clear-field" data-placeholder="Choisissez le nom du composant">
                                        <option value=""></option>
                                        @foreach ($composants as $composant)
                                            <option value="{{ $composant->id }}" @if ($tache->composant_id == $composant->id) selected @endif>
