...
<div class="card">
    ...
    <div class="d-lg-flex align-items-center mb-4 gap-3">
        <div class="position-relative">
            <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i> La Liste des info Annuelle activité budgetaire</h6>
        </div>
        <div class="ms-auto"><a href="{{route("infoAnnuelleActiviteBuds.create")}}" title="Creer une nouvelle section" class="btn btn-outline-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Ajouter</a></div>
    </div> <hr>
                ...
                <tbody>
                    ...
                    @foreach ($datas as $d)
                        <tr>
                            ...
                            <td>{{$d->quantite}}</td>
                            <td>{{$d->realisation}} </td>
                            <td>{{$d->budgetAlloue}} </td>
                            <td>{{$d->activityBudgetaire->code}} - {{$d->activityBudgetaire->libelle}}</td>
                             <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <a class="ms-1" href="{{ route('infoAnnuelleActiviteBuds.edit', $d->id) }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('infoAnnuelleActiviteBuds.destroy', $d->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
