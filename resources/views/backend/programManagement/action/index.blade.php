...
<div class="card">
    ...
    <div class="d-lg-flex align-items-center mb-4 gap-3">
        <div class="position-relative">
            <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i> La Liste des actions</h6>
        </div>
        <div class="ms-auto"><a href="{{route("actions.create")}}" title="Creer une nouvelle section" class="btn btn-outline-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Ajouter</a></div>
    </div> <hr>
                             ...
                             <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <a class="ms-1" href="#" data-bs-toggle="modal"
                                        data-bs-target="#actions{{ $d->id }}">
                                        <i class="bx bxs-plus-circle text-success"></i>
                                    </a>

                                    <a class="ms-1" href="{{ route('actions.edit', $d->id) }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('actions.destroy', $d->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="actions{{ $d->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
