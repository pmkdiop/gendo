...
<div class="card">
    <div class="card-body p-4">
        ...
        <form action="{{route("methodeCostings.update", [$data->id])}}" method="post">
        @csrf
        @method("PUT")
        <div class="row">
            <div class="col-lg-12">
            <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" value="{{$data->code}}" class="form-control @error('code') is-invalid @enderror" id="codeId" placeholder="Saisissez le code de la section ">
                        @error('code')
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" name="libelle" class="form-control @error('libelle') is-invalid @enderror" value="{{$data->libelle}}" id="libelleId" placeholder="Saisissez la section ">
                        @error('libelle')
                            <span class="text-danger"> {{ $message }}</span>
                        @enderror
                    </div>
