...
<div class="card">
    ...
    <div class="d-lg-flex align-items-center mb-4 gap-3">
        <div class="position-relative">
            <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i> La Liste des methodes costing</h6>
        </div>
        <div class="ms-auto"><a href="{{route("methodeCostings.create")}}" title="Creer une methode costing" class="btn btn-outline-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Ajouter</a></div>
    </div> <hr>
                            ...
                            <td>{{$d->typeDonnees}}</td>
                             <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <a class="ms-1" href="{{ route('methodeCostings.edit', $d->id) }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('methodeCostings.destroy', $d->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
