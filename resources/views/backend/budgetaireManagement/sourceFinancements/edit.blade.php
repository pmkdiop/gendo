...
<div class="card">
    <div class="card-body p-4">
        ...
        <div class="form-body mt-4">
            <form action="{{ route('sourceFinancements.update', $sourceFinancement->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" value="{{ $sourceFinancement->code }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="code1" value="{{ $sourceFinancement->code1 }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="libelle1"
                                    ...
                                    value="{{ $sourceFinancement->libelle1 }}" id="inputLibelle1"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="code2" value="{{ $sourceFinancement->code2 }}"
