        ...
        <div class="card-body p-4">
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                <div class="position-relative">
                    <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i> Création d'une nouvelle
                        dotation</h6>
                </div>
                <div class="ms-auto"><a href="{{ route('dotations.index') }}"
                        ...
                        <div class="col-lg-12">
                            <div class="border border-3 p-4 rounded">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="single-select-clear-field" class="form-label h6">Acivité budgétaire</label>
                                            ...
                                            @if (count($activite_bugs) > 0)
                                                @foreach ($activite_bugs as $activite_bug)
                                                    <option value="{{ $activite_bug->id }}"
                                                        {{ old('activite_budgetaire_id') == $activite_bug->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="single-select-clear-field1" class="form-label h6">Tâche du dotation</label>
