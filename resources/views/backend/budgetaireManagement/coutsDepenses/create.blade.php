        ...
        <div class="card-body p-4">
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                <div class="position-relative">
                    <h6 class="mb-0 text-uppercase"> <i class="bx bxs-plus-circle text-primary"></i>Création d'un coût de
                        dépense</h6>
                </div>
            ...
            <div class="form-body mt-4">
                <form action="{{ route('coutDepenses.store') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="libelle"
                                            ...
                                            value="{{ old('libelle') }}" id="inputLibelle"
                                    ...
                                    <div class="">
                                        ...
                                        placeholder="Saisissez la description du coût de dépense" rows="4"></textarea>
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('dotation_id') is-invalid @enderror"
                                        id="single-select-clear-field" data-placeholder="Sélectionner une dotation" name="dotation_id">
                                        <option value=""></option>
                                        @if (count($dotations) > 0)
                                            @foreach ($dotations as $dotation)
                                                <option value="{{ $dotation->id }}"
                                                    {{ old('dotation_id') == $dotation->id ? 'selected' : '' }}>{{ $dotation->code }} -
                                                    {{ $dotation->libelle }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('dotation_id')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('source_financement_id') is-invalid @enderror"
                                        id="single-select-clear-field1" data-placeholder="Sélectionner une source finance" name="source_financement_id">
                                        <option value=""></option>
                                        @if (count($sourceFinancements) > 0)
                                            @foreach ($sourceFinancements as $sourceFinancement)
                                                <option value="{{ $sourceFinancement->id }}"
                                                    {{ old('source_financement_id') == $sourceFinancement->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('rubrique_id') is-invalid @enderror"
                                        id="single-select-clear-field2" data-placeholder="Selectionner une rubrique" name="rubrique_id">
                                        <option value=""></option>
